...
let vlists =[["오디오북 녹음하기", "대한한국", "2022.02.28~2022.03.06", "2022.03.07~2023.01.31", "5/10"], ["자료 번역하기", "대한한국", "2022.02.28~2022.03.06", "2022.03.07~2023.01.31", "5/10"], ["디지털 취약계층을 위한 강의", "대한한국", "2022.02.28~2022.03.06", "2022.03.07~2023.01.31", "5/10"], ["강의 자막 업로드", "대한한국", "2022.02.28~2022.03.06", "2022.03.07~2023.01.31", "5/10"]];
                ...
                <div>
                    ...
                    (
                        <div className={styles.listbox} key={idex}>
                            ...
                            {/* <div>[국가] {item.country} &nbsp; [모집기간] {item.vrecuritperiod} &nbsp;  [봉사기간] {item.vtitle} &nbsp;  [신청인원] {item.vtitle}</div> */}
                        </div>
                    ))}
                </div>
            </div>
